  ...
  return (
    <nav 
      ...
      <div className="flex items-center justify-between">
        <a href="/" className={`text-purple-600 font-bold text-2xl btn ${buttonClass}`}>TaskFlow</a>
        ...
        <div className="hidden lg:flex items-center space-x-10">
          <button onClick={toggleFeatures}
            className={`flex items-center text-gray-600 btn btn-sm ${buttonClass} ${isFeaturesOpen ? '' : ''}`}>Features<i className={`${isFeaturesOpen ? 'ph-caret-up ml-1' : 'ph-caret-down ml-1'}`}></i>
          </button>
